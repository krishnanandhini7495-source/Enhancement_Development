    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InvoiceServices_Staff_StaffId",
                        column: x => x.StaffId,
            ...
            migrationBuilder.InsertData(
                table: "SalonSettings",
                columns: new[] { "Id", "BranchAddress", "CreatedAt", "Email", "Phone", "SalonName", "UpdatedAt" },
                values: new object[] { new Guid("00000000-0000-0000-0000-000000000001"), "123 Beauty Street, City", new DateTime(2025, 11, 29, 10, 3, 31, 882, DateTimeKind.Utc).AddTicks(1429), null, null, "Elegant Salon", new DateTime(2025, 11, 29, 10, 3, 31, 882, DateTimeKind.Utc).AddTicks(1430) });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceServices_StaffId",
                table: "InvoiceServices",
                column: "StaffId");
